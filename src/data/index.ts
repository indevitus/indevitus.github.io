    ...
    summary: [
      {
        ...
        iconDark: '/location-icon-white.png',
        title: 'Location',
        content: 'Lorem ipsum',
      },
      {
    ...
    description: [
      {
        ...
        content: [
          ...
          {
            id: 2,
            text: 'The ideal candidate will blend creativity with technical proficiency to craft immersive user experiences.'
          },
          {
            id: 3,
            text: 'Proficiency in HTML, CSS, and JavaScript is essential, along with a strong understanding of responsive design principles.'
          },
          {
            id: 4,
            text: `If you're someone who thrives in a collaborative environment and is driven to push the boundaries of web development, we want to hear from you`
          }
        ]
      },
      {
